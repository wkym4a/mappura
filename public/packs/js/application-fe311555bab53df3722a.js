  ...
  _createClass(_default, [{
    ...
    get: function get() {
      if (latlng_decided_flg == false) {
        ...
        this.btn_resetTarget.style.backgroundColor = '#A7F1FF'; // this.btn_saveTarget.disabled = true;
      } else {
        ...
        this.btn_setTargets[0].style.backgroundColor = '#A7F1FF';
        this.btn_setTargets[1].style.backgroundColor = '#A7F1FF';
        this.btn_resetTarget.style.backgroundColor = '#555555'; // this.btn_saveTarget.disabled = true;
        // this.btn_saveTarget.style.backgroundColor = '#555555';
      }
    }
  }]);
...
_default.targets = ["map", "latitude", "longitude", "btn_set", "btn_reset", "addreess", "btn_save"];
...
/******/ });
//# sourceMappingURL=application-fe311555bab53df3722a.js.map