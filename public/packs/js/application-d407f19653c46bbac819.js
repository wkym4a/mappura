...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function initialize() {
      ...
      this.make_pins(this.plan_pinsTarget, "blue", markers_plan_pin); //「pins_not_plan」……プランに所属していないピンを作成
    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          markers.push(marker);
          this.map.addFeature(marker); // //作成したマーカーをまとめる（Yahoo! Map Cluster
...
/******/ });
//# sourceMappingURL=application-d407f19653c46bbac819.js.map