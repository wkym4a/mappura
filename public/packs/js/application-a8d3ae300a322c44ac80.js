        ...
        for (var i = 0; i < this.pins.length; i++) {
          ...
          switch (pin_type) {
            ...
            default:
              ...
              // 描写もまた後で
              marker.bindInfoWindow('<div data-controller="make-speech-bubble-plan-candidate" class="speech_bubble_box"><input type="hidden" data-target = "make-speech-bubble-plan-candidate.pin_id" value= ' + this.pins[i].id + ' ><input type="hidden" data-target = "make-speech-bubble-plan-candidate.plan_id" value= ' + 1 + ' ><div id = "pin_id_' + this.pins[i].id + '_onmap" >aaaa</div></div>');
              break;
          } // //クリックすると詳細を表示(詳細の中身はこの段階では未作成、
          // // 「make-speech-bubble_controller.js」のロードイベントで描写する)
          // // 描写もまた後で
...
/******/ });
//# sourceMappingURL=application-a8d3ae300a322c44ac80.js.map