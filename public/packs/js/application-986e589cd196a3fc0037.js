    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div data-controller="make-speech-bubble"><input type = "submit" data-action="click->make-speech-_bubble#tttt"></div>'); // marker.bindInfoWindow('<div data-controller="tete"><input type = "submit" data-action="click->tete#tttt"></div>');
...
/******/ });
//# sourceMappingURL=application-986e589cd196a3fc0037.js.map