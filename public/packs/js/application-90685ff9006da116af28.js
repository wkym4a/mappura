    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<br>やっほー、はね丸です。<br>リアルでは一度も訪れたことはありませんが…。(笑)<%= 22.to_s %>'); // marker.bindInfoWindow('<%= render "index_item", pin: pin , item_num: i ,currentuser_info: currentuser_info,currentuser_workboxes: currentuser_workboxes,currentuser_plans: currentuser_plans %>');
...
/******/ });
//# sourceMappingURL=application-90685ff9006da116af28.js.map