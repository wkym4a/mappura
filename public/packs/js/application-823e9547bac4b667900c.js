...
$(function () {
  $fileField = $('#pin_image'); // 選択された画像を取得し表示

  $($fileField).on('change', $fileField, function (e) {
    file = e.target.files[0];
    reader = new FileReader(), $preview = $("#image_field_pin_create");
...
//     var $preview = this.image_fieldTarget;
//
//     reader.onload = (function(file) {
//       return function(e) {
//         // $preview.empty();
...
/******/ });
//# sourceMappingURL=application-823e9547bac4b667900c.js.map