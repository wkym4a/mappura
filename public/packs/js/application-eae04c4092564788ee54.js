    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<%= render "drawind_pins/test_form" %>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id + '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-eae04c4092564788ee54.js.map