...
var map = {
	...
	"./edit_pin_controller.js": "./app/javascript/controllers/edit_pin_controller.js",
	...
	"./password_change_or_not_controller.js": "./app/javascript/controllers/password_change_or_not_controller.js",
	...
	"./presentation_controller.js": "./app/javascript/controllers/presentation_controller.js",
...
var markers = [];
var markers_reference = []; // 座標が確定されているかどうが」のフラグ
...
function (_Controller) {
  ...
  _createClass(_default, [{
      ...
      this.map.bind('dblclick', function (e) {
        ...
        if (markers_reference.length > 0) {
          for (var i = 0; i < markers_reference.length; i++) {
            map_box.removeFeature(markers_reference[i]); // markers[i].setMap(null);
          }
        ...
        markers_reference.push(marker); // // ピンの場所に移動
    ...
    value: function set_by_latlng() {
      ...
      var current_location = new Y.LatLng(this.latitudeTarget.value, this.longitudeTarget.value); // ↓マーカー作成→既存マーカー削除→作成したメーカーを設置→作成マーカーを保存
...
_default.targets = ["map", "reference_1", "reference_2", "reference_3", "latitude", "longitude", "btn_set", "msg", "btn_reset", "btn_save"];


/***/ }),

/***/ "./app/javascript/controllers/edit_pin_controller.js":
/*!***********************************************************!*\
  !*** ./app/javascript/controllers/edit_pin_controller.js ***!
  \***********************************************************/
/*! exports provided: default */
...
_default.targets = ["map", "latitude", "longitude", "btn_move"];
...
/***/ "./app/javascript/controllers/password_change_or_not_controller.js":
/*!*************************************************************************!*\
  !*** ./app/javascript/controllers/password_change_or_not_controller.js ***!
  \*************************************************************************/
/*! exports provided: default */
...
_default.targets = ["check", "password", "password_confirmation"];
...
/***/ "./app/javascript/controllers/presentation_controller.js":
/*!***************************************************************!*\
  !*** ./app/javascript/controllers/presentation_controller.js ***!
  \***************************************************************/
/*! no static exports found */
...
_default.targets = ["selected_info", "base_url_1", "base_url_2", "btn"];
...
/******/ });
//# sourceMappingURL=application-a3dc5d083aa2fb21f224.js.map