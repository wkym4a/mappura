    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div data-controller="make-speech-_bubble"><input type = "submit" data-action="click->make-speech-_bubble#tttt"></div>'); // marker.bindInfoWindow('<div data-controller="tete"><input type = "submit" data-action="click->tete#tttt"></div>');
          // marker.bindInfoWindow('<div id = "pin_id_' + this.pins[i].id  +  '" data-controller="make-speech-_bubble" value = ' + this.pins[i].id  +  '>aaaa</div>');
...
/******/ });
//# sourceMappingURL=application-16e8433a0feff1b13062.js.map