  ...
  _createClass(_default, [{
    ...
    value: function change_btn(el) {
      if (el.target.checked == true) {
        ...
        this.btnTargets.checked = false;
        el.checked = true; // this.btnTargets.forEach((el, i) => {
        // if(i != this.index_num)  el.checked = false;
      }
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-c816731a298beaeebeea.js.map