    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div class="pin_id_1111">' + '222222' + '</div>');
          $(".pin_id_1111").html("<div>aaaaaavvvvvv</div>"); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-57329d90b2a23024773e.js.map