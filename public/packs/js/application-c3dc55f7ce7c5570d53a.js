...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function initialize() {
      ...
      this.pins = JSON.parse(this.plan_pinsTarget.value);

      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          var current_location = new Y.LatLng(this.pins[i].latitude, this.pins[i].longitude); // タイトルを付けるように変更

          var icon = new Y.Icon('https://chart.googleapis.com/chart?chst=d_map_pin_letter_withshadow&chld=11|00BFFF|000000'); // var icon = new Y.Icon('https://s.yimg.jp/images/map/yy/images/icon/yy_aicon_06_32pix.gif');
          ...
          markers_plan_pin.push(marker); //作成したマーカーをまとめる（Yahoo! Map Cluster

          new YmapCluster(this.map, markers_plan_pin);
        }
      }
    ...
    key: "testt",
    value: function testt(pins, pin_type) {
      console.log("aaaa" + pins + "bbbb" + pin_type);
...
_default.targets = ["pins_not_plan", "plan_pins", "map", "latitude", "longitude"];
...
/******/ });
//# sourceMappingURL=application-c3dc55f7ce7c5570d53a.js.map