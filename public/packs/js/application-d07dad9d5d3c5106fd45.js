    ...
    value: function set_latlng_by_address() {
      ...
      geocoder.execute(request, function (ydf) {
        if (ydf.features.length > 0) {
          ...
          this.btn_sets[0].style.backgroundColor = '#555555';
          this.btn_sets[1].style.backgroundColor = '#555555';
          this.btn_reset.style.backgroundColor = '#A7F1FF';
...
/******/ });
//# sourceMappingURL=application-d07dad9d5d3c5106fd45.js.map