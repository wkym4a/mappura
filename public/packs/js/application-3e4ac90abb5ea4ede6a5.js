...
function (_Controller) {
  ...
  _createClass(_default, [{
    key: "btn",
    // 登録済みの一覧情報を選択すると、その情報の位置に移動する
    value: function btn(el) {
      var _this = this;

      if (el.target.checked == true) {
        this.index_num = el.target.dataset.actionIndexNum;
        this.btnTargets.forEach(function (el, i) {
          if (i != _this.index_num) el.checked = false;
        });
      }
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-3e4ac90abb5ea4ede6a5.js.map