    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div data-controller="make-speech-bubble" ><div id = "pin_id_' + this.pins[i].id + '" data-target = "make-speech-bubble.speech_bubble"  value = ' + this.pins[i].id + '></div></div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-6821fe28c52f815895db.js.map