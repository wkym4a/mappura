  ...
  _createClass(_default, [{
    ...
    value: function initialize(e) {
      ...
      this.map.bind('dblclick', function (e) {
        ...
        this.reference_1Target.value = '【位置参照情報】下記の地点がダブルクリックされました。';
        this.reference_2Target.value = '緯度:「' + e.Lat + '」、経度:「' + e.Lat + '」';
        txt_reference_3 = this.reference_3Target;
        var current_location = new Y.LatLng(e.Lat, e.Lat);
        var request = {
        ...
        geocoder.execute(request, function (ydf) {
          if (ydf.features.length > 0) {
            ...
            if (feature.property.Address == "") {
              txt_reference_3.text = feature.property.Country.Name;
            } else {
              txt_reference_3.text = feature.property.Address;
            }
          } else {
...
_default.targets = ["map", "reference_1", "reference_2", "reference_3", "latitude", "longitude", "btn_set", "btn_reset", "btn_save"];
...
/******/ });
//# sourceMappingURL=application-ab7a060cc73530561807.js.map