    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div data-controller="tete"><input type = "submit" data-action="click->tete#tttt"></div>'); // marker.bindInfoWindow('<div id = "pin_id_' + this.pins[i].id  +  '" data-controller="make-speech-_bubble" value = ' + this.pins[i].id  +  '>aaaa</div>');
...
/******/ });
//# sourceMappingURL=application-aedfa300f30104c7f256.js.map