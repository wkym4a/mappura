    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id + '">' + '222222' + '</div>'); // marker.bindInfoWindow('<%= render "index_item", pin: pin , item_num: i ,currentuser_info: currentuser_info,currentuser_workboxes: currentuser_workboxes,currentuser_plans: currentuser_plans %>');
...
/******/ });
//# sourceMappingURL=application-220066144741fdeaeb0b.js.map