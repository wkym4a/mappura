    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id + '">' + '222222' + '</div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
          ...
          $('#pin_id_' + this.pins[i].id).html("<div>aaaaaavvvvvv</div>"); //作成したマーカーをまとめる（Yahoo! Map Cluster
...
/******/ });
//# sourceMappingURL=application-c6daae5a8b0e7ac84848.js.map