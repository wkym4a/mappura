...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function initialize(e) {
      ...
      this.map.addControl(searchcontrol); // this.map.addListener('click', function(e) {
      //     console.log("ewrtgfee")
      //   // getClickLatLng(e.latLng, this.map);
      // });
    }
  }, {
    key: "set_pin_by_click",
    value: function set_pin_by_click(e) {
      console.log("ewrtgfee");
    } // getClickLatLng(lat_lng, map) {
    //
    //   console.log('dtthfolp.iku'')
    //
    //    // // 座標を表示
...
/******/ });
//# sourceMappingURL=application-8275102f72ee283f127e.js.map