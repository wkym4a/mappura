    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          var icon = new Y.Icon('https://chart.googleapis.com/chart?chst=d_map_pin_letter_withshadow&chld=1|00BFFF|00BFFF'); // var icon = new Y.Icon('https://s.yimg.jp/images/map/yy/images/icon/yy_aicon_06_32pix.gif');
...
/******/ });
//# sourceMappingURL=application-9a34e5b4c47c664fa47a.js.map