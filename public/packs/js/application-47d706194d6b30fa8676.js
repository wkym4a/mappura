    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<a id="pin_id_' + this.pins[i].id + '"　data-action="click->pin-index#bubble_open">' + '222222' + '</a>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-47d706194d6b30fa8676.js.map