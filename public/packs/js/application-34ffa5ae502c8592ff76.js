        ...
        geocoder.execute(request, function (ydf) {
          if (ydf.features.length > 0) {
            ...
            if (feature.property.Address == "") {
              this.reference_2Target.text = feature.property.Country.Name;
            } else {
              this.reference_2Target.text = feature.property.Address;
            }
          } else {
            txt_msg.text = "住所:ダブルクリックされた地点の住所取得にしっぱいしました。";
          }
        }); // //////////
...
/******/ });
//# sourceMappingURL=application-34ffa5ae502c8592ff76.js.map