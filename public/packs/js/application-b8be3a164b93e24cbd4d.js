    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id + '"　data-target="pin-index.speech_bubble"　data-action="load->pin-index#bubble_open">' + '222222' + '</div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-b8be3a164b93e24cbd4d.js.map