    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div class="pin_id_1111">' + '222222' + '</div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
          ...
          $(".pin_id_1111").html("<div>aaaaaavvvvvv</div>"); //作成したマーカーをまとめる（Yahoo! Map Cluster
...
/******/ });
//# sourceMappingURL=application-6a0db26a0abfdfc1261f.js.map