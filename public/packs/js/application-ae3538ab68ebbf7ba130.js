    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div class="pin_id_">' + '222222' + '</div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-ae3538ab68ebbf7ba130.js.map