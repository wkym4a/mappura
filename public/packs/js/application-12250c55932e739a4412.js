...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function select() {
      console.log('Hello, Stimulus!'); // XMLHttpRequest オブジェクトを作成

      var xhr = new XMLHttpRequest(); // 出力テスト
...
_default.targets = ["pin", "selected_info", "selected_info_type", "btn"];
...
/******/ });
//# sourceMappingURL=application-12250c55932e739a4412.js.map