...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function initialize() {
      ...
      //////////////////////////////
      // this.make_pins(this.plan_pinsTarget,"blue",markers_plan_pin);
    ...
    value: function make_pins(pins_info, pin_type, pin_storage_box) {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          pin_storage_box.push(marker); //作成したマーカーをまとめる（Yahoo! Map Cluster
...
/******/ });
//# sourceMappingURL=application-ede70ba81640e276d986.js.map