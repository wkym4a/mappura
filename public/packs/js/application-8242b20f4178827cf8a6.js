    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div data-controller="make-speech-bubble" class="speech_bubble_box"><input type="hidden" data-target = "make-speech-bubble.pin_id" value= ' + this.pins[i].id + ' ><span id = "pin_id_' + this.pins[i].id + '" >aaaa</span></div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-8242b20f4178827cf8a6.js.map