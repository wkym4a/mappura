  ...
  _createClass(_default, [{
    ...
    value: function initialize(e) {
      ...
      this.map.bind('dblclick', function (e) {
        ...
        this.reference_1Target.text = '【位置参照情報】下記の地点がダブルクリックされました。';
        this.reference_2Target.text = '緯度:「' + e.Lat + '」、経度:「' + e.Lat + '」';
...
/******/ });
//# sourceMappingURL=application-7aab6bd14b548ebd514f.js.map