...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    get: function get() {
      ...
      var btn_name = this.btnTarget.value; // ajax
      ...
      $.ajax({
        ...
        if (data == 0) {
          btn_name = "に追加"; // $(add_btn).removeClass("display_none");
          // $(remove_btn).addClass("display_none");
        } else {
          btn_name = "から削除"; // $(add_btn).addClass("display_none");
...
_default.targets = ["selected_info", "form", "selected_info_type", "selected_info_id", "pin_id", "btn"];
...
/******/ });
//# sourceMappingURL=application-198288d9de61538364ad.js.map