    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<%= render "index_item", pin: pin , item_num: i ,currentuser_info: currentuser_info,currentuser_workboxes: currentuser_workboxes,currentuser_plans: currentuser_plans %>'); // marker.bindInfoWindow(this.pins[i].pin_article);
...
/******/ });
//# sourceMappingURL=application-8d3855d38319ca1f3255.js.map