...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function initialize(e) {
      ...
      this.map.data_action = "click->create_pin#set_pin_by_click";
      ...
      this.map.bind('dblclick', function (e) {
        ...
        // getClickLatLng(e.latLng, this.map);
        // get getClickLatLng(lat_lng, map) {
        this.latitudeTarget.textContent = e.latLng.lat();
        this.longitudeTarget.textContent = e.latLng.lng();
        var current_location = new Y.LatLng(e.latLng.lat(), e.latLng.lng());
        var marker = new Y.Marker(current_location);
        this.map.addFeature(marker);
        this.map.panTo(current_location, true);
      });
    } // set_pin_by_click(e){
    //    console.log("ewrtgfee")
    // }
    // get getClickLatLng(lat_lng, map) {
    ...
    value: function tttt() {
      return "eeee"; // // 座標を表示
      // this.latitudeTarget.textContent = lat_lng.lat();
      // this.longitudeTarget.textContent = lat_lng.lng();
      //
      // var current_location = new Y.LatLng(lat_lng.lat(),lat_lng.lng())
      //
      // var marker = new Y.Marker(current_location);
      // this.map.addFeature(marker);
      //
...
/******/ });
//# sourceMappingURL=application-0136fde5a86343a2cf83.js.map