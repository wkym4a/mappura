    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div class="' + this.pins[i].id + '">' + '222222' + '</div>'); // marker.bindInfoWindow('<%= render "index_item", pin: pin , item_num: i ,currentuser_info: currentuser_info,currentuser_workboxes: currentuser_workboxes,currentuser_plans: currentuser_plans %>');
...
/******/ });
//# sourceMappingURL=application-f21da8db75e47a469387.js.map