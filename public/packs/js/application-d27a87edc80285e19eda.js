    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div id = "pin_id_' + this.pins[i].id + '" data-controller="make-speech-_bubble" value = "' + this.pins[i].id + '"></div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-d27a87edc80285e19eda.js.map