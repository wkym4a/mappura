    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow(this.pins[i].pin_article); // 「YmapCluster」を使用するため、不要
          // this.map.addFeature(marker);
          // // 作成したマーカーを保存
...
/******/ });
//# sourceMappingURL=application-c9e06817423d6a872fc2.js.map