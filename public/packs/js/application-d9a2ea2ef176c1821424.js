    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div id = "pin_id_' + this.pins[i].id + '" data-controller="make-speech-bubble" data-target = "make-speech-bubble.speech_bubble"  value = ' + this.pins[i].id + '>aaaa</div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-d9a2ea2ef176c1821424.js.map