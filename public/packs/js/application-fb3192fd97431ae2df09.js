  ...
  _createClass(_default, [{
    ...
    value: function initialize(e) {
      ...
      this.map.bind('dblclick', function (e) {
        ...
        txt_reference_1.text = '【位置参照情報】下記の地点がダブルクリックされました。';
        txt_reference_2.text = '緯度:「' + e.Lat + '」、経度:「' + e.Lon + '」';
        ...
        geocoder.execute(request, function (ydf) {
          if (ydf.features.length > 0) {
            ...
            if (feature.property.Address == "") {
              txt_reference_3.text = "住所:" + feature.property.Country.Name;
            } else {
              txt_reference_3.text = "住所:" + feature.property.Address;
            }
          } else {
            txt_reference_3.text = "住所:ダブルクリックされた地点の住所取得にしっぱいしました。";
          }
        }); // //////////
        // var current_location = new Y.LatLng(e.Lat,e.Lon)

        var icon = new Y.Icon('https://chart.googleapis.com/chart?chst=d_map_pin_letter_withshadow&chld=|00BFFF|000000'); // var icon = new Y.Icon('https://chart.googleapis.com/chart?chst=d_map_pin_letter_withshadow&chld=参|FFFF00|000000');
...
/******/ });
//# sourceMappingURL=application-fb3192fd97431ae2df09.js.map