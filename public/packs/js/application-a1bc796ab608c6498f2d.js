...
var map = {
	...
	"./maptest2_controller.js": "./app/javascript/controllers/maptest2_controller.js",
...
/***/ "./app/javascript/controllers/maptest2_controller.js":
/*!***********************************************************!*\
  !*** ./app/javascript/controllers/maptest2_controller.js ***!
  \***********************************************************/
/*! exports provided: default */
    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<div data-controller="maptest2"><input type="submit" id="pin_id_' + this.pins[i].id + '"　data-action="click->maptest2#bubble_open"></div>'); // marker.bindInfoWindow('<div id="pin_id_' + this.pins[i].id  +  '">' + '222222' + '</div>');
...
/******/ });
//# sourceMappingURL=application-a1bc796ab608c6498f2d.js.map