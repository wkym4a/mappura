...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    get: function get() {
      return {
        lat: this.latitudeTargets[this.action_pin_id].value,
        lng: this.longitudeTargets[this.action_pin_id].value
      };
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-bd62a078b89b19c80917.js.map