  ...
  _createClass(_default, [{
    ...
    value: function initialize(e) {
      ...
      this.map.bind('dblclick', function (e) {
        ...
        txt_reference_1.value = '【位置参照情報】下記の地点がダブルクリックされました。';
        txt_reference_1.value = '緯度:「' + e.Lat + '」、経度:「' + e.Lat + '」';
        ...
        geocoder.execute(request, function (ydf) {
          if (ydf.features.length > 0) {
            ...
            if (feature.property.Address == "") {
              txt_reference_3.value = feature.property.Country.Name;
            } else {
              txt_reference_3.value = feature.property.Address;
            }
          } else {
            txt_reference_3.value = "住所:ダブルクリックされた地点の住所取得にしっぱいしました。";
          }
        }); // //////////
...
/******/ });
//# sourceMappingURL=application-88f58757d2a311b57906.js.map