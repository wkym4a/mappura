    ...
    value: function initialize() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          this.map.addFeature(marker); // // 作成したマーカーを保存（念の為

          markers.push(marker); //作成したマーカーをまとめる（Yahoo! Map Cluster
...
/******/ });
//# sourceMappingURL=application-6a66ff38127145e1b58e.js.map