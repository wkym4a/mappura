    ...
    value: function connect() {
      ...
      if (this.pins.length > 0) {
        for (var i = 0; i < this.pins.length; i++) {
          ...
          marker.bindInfoWindow('<br>やっほー、はね丸です。<br>リアルでは一度も訪れたことはありませんが…。(笑)'); // marker.bindInfoWindow('<%= render "index_item", pin: pin , item_num: i ,currentuser_info: currentuser_info,currentuser_workboxes: currentuser_workboxes,currentuser_plans: currentuser_plans %>');
...
/******/ });
//# sourceMappingURL=application-c2b8c1d2a7bd0f380ebd.js.map